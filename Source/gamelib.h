...
#define GAME_CYCLE_TIME		 21		    // 每33ms跑一次Move及Show(每秒30次)
...
namespace game_framework {
	...
	enum class PAUSE
	{
		RESUME, CHEAT, OPTIONS, SAVE_EXIT, GIVE_UP,
		AMOUNT
	};
	...
	protected:
		...
		CGame *game;
		static bool startedNewGame;
		static bool turnOnDisplayTimer;
